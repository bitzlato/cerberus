module StubHelper
  ...
  def stub_websdk_link(public_id: 1111, body: nil)
    response = body || { "url": "https://api.sumsub.com/idensic/l/#/#{SecureRandom.hex}" }
    stub_request(:post, "https://test-api.sumsub.com/resources/sdkIntegrations/levels/basic-kyc-level/websdkLink?externalUserId=#{public_id}&lang=en&ttlInSecs=3600").
