...
describe SumSub::GenerateUrl do
  describe 'generate link' do
    before do
      ...
      stub_websdk_link(sumsub_applicant_id: @public_id)
    end

    it 'ok' do
      klass = described_class.new(sumsub_applicant_id: @public_id)
      url = klass.call
  ...
  describe 'cache url' do
    ...
    it 'ok' do
      described_class.clear_cache
      generate_url =  described_class.new(sumsub_applicant_id: @public_id)
